...
export function Header() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b shadow-sm hover:shadow-md transition-shadow">
